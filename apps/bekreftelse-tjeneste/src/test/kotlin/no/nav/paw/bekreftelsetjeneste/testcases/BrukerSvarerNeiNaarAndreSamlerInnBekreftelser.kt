...
class BrukerSvarerNeiNaarAndreSamlerInnBekreftelser : FreeSpec({
    ...
    with(
        ...
        forventer<BaOmAaAvsluttePeriode>(
            kilde,
            input,
            fra = "24.02.2025 12:01".timestamp,
            til = "24.02.2025 12:05".timestamp
        )
        forventer<PeriodeAvsluttet>(
            kilde,
            input,
            fra = "24.02.2025 12:01".timestamp,
            til = "24.02.2025 12:07".timestamp
        )
