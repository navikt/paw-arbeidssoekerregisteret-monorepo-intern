package no.nav.paw.arbeidssoekerregisteret.bekreftelse.minsideoppgaver.service
...
import no.nav.paw.arbeidssoekerregisteret.bekreftelse.minsideoppgaver.model.asInsertPeriodeRow
import no.nav.paw.arbeidssoekerregisteret.bekreftelse.minsideoppgaver.model.asInsertVarselRow
import no.nav.paw.arbeidssoekerregisteret.bekreftelse.minsideoppgaver.model.asUpdatePeriodeRow
import no.nav.paw.arbeidssoekerregisteret.bekreftelse.minsideoppgaver.model.asUpdateVarselRow
...
class VarselService(
    ...
    fun mottaVarselHendelse(hendelse: VarselHendelse) = transaction {
        val varselRow = varselRepository.findByBekreftelseId(UUID.fromString(hendelse.varselId))
        if (varselRow != null) {
