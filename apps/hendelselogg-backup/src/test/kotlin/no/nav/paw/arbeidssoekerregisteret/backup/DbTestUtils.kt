...
import no.nav.paw.arbeidssoekerregisteret.backup.database.HendelseTable
...
fun readRecord(consumerVersion: Int, partition: Int, offset: Long): StoredData? {
...
fun getOneRecordForId(id: String): StoredData? =
