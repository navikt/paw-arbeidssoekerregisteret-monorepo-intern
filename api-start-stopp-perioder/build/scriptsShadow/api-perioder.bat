...
set CLASSPATH=%APP_HOME%\lib\api-perioder-all.jar

@rem Execute api-perioder
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %API_PERIODER_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%API_PERIODER_EXIT_CONSOLE%" exit 1
exit /b 1
