...
class KafkaStreamConfig(map: Map<String, String>) {
    ...
    val periodeTopic = map.konfigVerdi<String>("PERIODE_TOPIC")
    val situasjonTopic = map.konfigVerdi<String>("SITUASJON_TOPIC")
    ...
    private val standardProperties = mapOf(
        ...
        KafkaAvroSerializerConfig.SCHEMA_REGISTRY_URL_CONFIG to map.konfigVerdi<String>(KAFKA_SCHEMA_REGISTRY),
